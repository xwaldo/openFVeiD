...
Project files retain their active ground, lighting, mist, and skybox settings. Projects
created by older FVD++ versions remain supported and use the default environment for
settings that were not present in their files.
