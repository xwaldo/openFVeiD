#ifndef SECGEOMETRICRIDERLOCAL_H
#define SECGEOMETRICRIDERLOCAL_H
...
class secgeometricriderlocal : public section {
public:
    ~secgeometricriderlocal();
    secgeometricriderlocal(track* getParent, mnode* first, float getlength = 10.0);
...
#endif // SECGEOMETRICRIDERLOCAL_H
